...
export const ThankYou = () => {
  ...
  if (data === undefined) {
    return (
      <div className="w-ful t-24 flex justify-center ">
        <div className="flex flex-col items-center gap-2">
          <Loader2 className="h-8 w-8 animate-spin text-zinc-500" />

          <h3 className="font-semibold text-xl">Loading yor order...</h3>
  ...
  return (
    <div className="bg-white ">
      <div className="mx-auto max-w-3x px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="max-w-xl">
          ...
          <div className="text-sm mt-12 font-medium">
